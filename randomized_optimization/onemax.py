...
itersList = 2 ** np.arange(14)

rhc = mlrose_hiive.RHCRunner(problem=problem,
                       experiment_name="RCH",
                       output_directory="../onemax_problem",
                       seed=None,
...
plt.figure()
plt.title('RHC Runner for onemax')
plt.plot(rhc_run_curves.Fitness, label='Fitness score',color="navy")
plt.xlabel('Iteration')
plt.ylabel("Fitness")
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_rhc_fitness_onemax.png')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_rhc_time_onemax.png')
...
plt.figure()
plt.title('SA Runner for onemax')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_sa_fitness_onemax.png')
...
plt.figure()
plt.title('GA Runner for onemax')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_ga_fitness_onemax.png')
...
plt.figure()
plt.title('MIMIC Runner for onemax')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_mimic_fitness_onemax.png')
...
plt.figure()
plt.title('Alogrithm Comparison for onemax')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_fitness_onemax.png')



plt.figure()
plt.title('Alogrithm Comparison for onemax Time')
...
plt.legend(loc="best")
plt.grid()
plt.savefig(save_path + '4p_fitness_onemax_time.png')
